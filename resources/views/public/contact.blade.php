...
@section('content')
    ...
    <div class="bg-white lg:rounded-2xl dark:bg-[#111111]">
        ...
        <div
            ...
            <h3 class="text-4xl">
                @if (session('status'))
                    <span style="color:red">Tu mensaje se ha enviado correctamente</span>

                @endif
                
                <span class="text-gray-lite dark:text-[#A6A6A6]">Para sugerencias o integraciones en desarrollo de productos.</span>
                <br />
        ...
        <footer class="overflow-hidden rounded-b-2xl" style="background: transparent">
            <p class="text-center py-6 text-gray-lite dark:text-color-910"> © 2023 Todos los derechos reservados
                by <a class="hover:text-[#FA5252] duration-300 transition"
                    ...
                    rel="noopener noreferrer"> Estefanía León </a>. </p>
        </footer>
        <!-- footer section end -->
    </div>
    <!-- contact section start -->
